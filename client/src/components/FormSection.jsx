            ...
            <div className="field">
              ...
              <div className="control">
                <input
                  className="input"
                  value={
                    this.props.user.resumes[this.props.selectedResume].name
                  }
                  onChange={this.handleResumeUpdate.bind(this, "name")}
                  type="text"
            ...
            <div className="field">
              ...
              <div className="control">
                <textarea
                  ...
                  className="textarea"
                  value={
                    this.props.user.resumes[this.props.selectedResume].about
                  }
                  onChange={this.handleResumeUpdate.bind(this, "about")}
                  type="text"
            ...
            <div className="field">
              ...
              <div className="control">
                <input
                  className="input"
                  value={
                    this.props.user.resumes[this.props.selectedResume].email
                  }
                  onChange={this.handleResumeUpdate.bind(this, "email")}
                  type="email"
            ...
            <div className="field">
              ...
              <div className="control">
                <input
                  className="input"
                  value={
                    this.props.user.resumes[this.props.selectedResume].address
                  }
                  onChange={this.handleResumeUpdate.bind(this, "address")}
                  type="address"
            ...
            <div className="field">
              ...
              <div className="control">
                <input
                  className="input"
                  value={
                    this.props.user.resumes[this.props.selectedResume].phone
                  }
                  onChange={this.handleResumeUpdate.bind(this, "phone")}
                  type="phone"
      ...
      case "experience":
        return (
          <div className="experience m-b-30 p-20">
            {this.props.user.resumes[this.props.selectedResume].experience.map(
              (item, index) => (
                <div
                ...
                >
                  <button
                    ...
                    onClick={this.removeExperience.bind(this, index)}
                  >
                    &#10006;
                  </button>
                  <div className="field column is-12">
                    ...
                    <div className="control">
                      <input
                        className="input"
                        value={item.name}
                        onChange={this.handleExperienceUpdate.bind(
                          this,
                          "name",
                          index
                        )}
    ...
    return (
      <div className="display-flex">
        {prev ? (
          <button
            type="button"
            className="nav-button navbar-start button is-info"
            onClick={this.props.switchForm.bind(null, prev)}
          >
            {prev} &#8678;
          </button>
        ) : (
        ...
        {next ? (
          <button
            type="button"
            className="nav-button navbar-end button is-info"
            onClick={this.props.switchForm.bind(null, next)}
          >
            {next} &#8680;
          </button>
        ) : (
  ...
  render() {
    return (
      <section id="form-section" className="no-print column is-4 p-l-50 p-r-50">
        <div className="title is-4 form-title">{this.props.activeForm}</div>
        {this.renderNav(this.props.activeForm)}
        <div className="save-section columns is-centered">
          <button
            type="button"
            className={
              "button m-20 " + (this.props.saving ? "is-loading" : "is-primary")
            }
            onClick={this.props.save}
          >
            Save
          </button>
          {this.props.activeForm === "experience" ? (
            <button
              type="button"
